...
urlpatterns = [
    ...
    path('interest-on-securities-info/<int:pk>/', views.interest_on_securities_info,
         name='interest-on-securities-info'),
    path('interest-on-securities-delete/', views.interest_on_securities_delete,
         name='interest-on-securities-delete'),
    ...
    path('confirm-expenses-copy/', views.confirm_expenses_copy, name='confirm-expenses-copy'),
    ...
    path('generate-expenses-data', views.generate_expenses_data,
         name='generate-expenses-data'),
    ...
    path('copy-expenses-data', views.copy_expenses_data,
         name='copy-expenses-data'),
]
